...
const ReadListHandler = {
    canHandle(handlerInput) {
        return Alexa.getRequestType(handlerInput.requestEnvelope) === 'IntentRequest'
            && Alexa.getIntentName(handlerInput.requestEnvelope) === 'ReadList';
    },
    handle(handlerInput) {
        const speakOutput = 'Here are the items on your shopping list:';
        return handlerInput.responseBuilder
            .speak(speakOutput)
            .reprompt()
            .getResponse();
...
const CancelAndStopIntentHandler = {
    ...
    handle(handlerInput) {
        const speakOutput = 'Goodbye! Now closing your Shopping List.';
        return handlerInput.responseBuilder
            .speak(speakOutput)
            .getResponse();
    }
...
const ErrorHandler = {
    ...
    handle(handlerInput, error) {
        ...
        const speakOutput =  'There was a problem with the requested skills response';
